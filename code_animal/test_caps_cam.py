# -*- coding: utf-8 -*-
"""
Created on Thu Oct 18 08:51:09 2018

@author: zhangjj
"""
# test for double branch model, eg: vgg+cam+caps, vgg+cam
...
list_root_train = '/data/zjj/focus/lists/animals/training.txt'
...
def test():
    ...
    preds1 = [] #1 branch
    preds2 = [] #2 branch
    for ii, (test_img, test_label) in enumerate(test_dataloader):
