# -*- coding: utf-8 -*-
"""
Created on Thu Oct 18 08:50:56 2018
...
list_root = '/data/zjj/focus/lists/animals/training.txt'
list_root_test = '/data/zjj/focus/lists/animals/testing.txt'
...
if __name__ == '__main__':
    ...
    ## change the path for pretrained vgg16_bn model
    pretrained_model.load_state_dict(torch.load('/data/zjj/focus/code_face/pretrained/vgg16_bn.pth'))
    ...
    # scheduler = optim.lr_scheduler.MultiStepLR(optimizer1, milestones=[49,64], gamma=0.1)
