...
def res2net50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load('./pretrained/res2net50_26w_4s-06e79181.pth'))
    return model
...
def res2net50_26w_8s(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load('./pretrained/res2net50_26w_8s-2c7c9f12.pth'))
    return model
...
def res2net50_48w_2s(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load('./pretrained/res2net50_48w_2s-afed724a.pth'))
    return model
